...
<form method="post" action="{{ route('paid.save') }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="unit" class="control-label col-md-3 col-sm-3 col-xs-12">计量单位 <span class="required">*</span></label>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" id="unit" name="unit" value="{{ old('unit') }}"  placeholder="计量单位" required>
		</div>
	</div>
	<div class="form-group">
		<label for="amount" class="control-label col-md-3 col-sm-3 col-xs-12">数量 <span class="required">*</span></label>
		<div class="col-md-6 col-sm-6 col-xs-12">
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" id="authority" name="authority" value="{{ old('authority') }}"  placeholder="开具证明税务机关" required>
		</div>
	</div>
	<div class="form-group">
		<label for="sale" class="control-label col-md-3 col-sm-3 col-xs-12">销售单位名称 <span class="required">*</span></label>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" id="sale" name="sale" value="{{ old('sale') }}"  placeholder="销售单位名称" required>
		</div>
	</div>
	<div class="form-group">
